    ...
    <div className="flex flex-row px-3 pb-4">
      ...
      <div className="pl-2 w-50">
        <button
          ...
          className=" sm:w-4/6 md:w-4/12 py-2 font-lexend font-bold text-acm-white border-2 border-acm-marine text-xl transition-colors duration-150 bg-acm-marine rounded-lg focus:shadow-outline hover:border-acm-black"
        >
          submit
        </button>
